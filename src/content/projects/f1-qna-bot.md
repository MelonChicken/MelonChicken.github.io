...
![Notion image](/notion-assets/f1-qna-bot/2ec14b84a0f28097b03fe9d5c6406b76.png)
...
2. **Text / Table 분리 인덱싱** — 텍스트와 표를 서로 다른 retriever로 관리하여 검색 정확도 향상

    / 엣지 케이스: 표 질의 시 JSON → DataFrame 변환

3. **Query Routing 기반 Retriever 선택** — 키워드 기반으로 text / table retriever 자동 선택
