const projects = [
  {
    "name": "Site-Generalized Wildlife Classifier",
    "name_en": "Site-Generalized Wildlife Classifier",
    "status": "In Progress",
    "description": "카메라트랩 이미지를 전통 특징(HOG)과 scikit-learn 확률 분류기로 분류하고, site 단위 일반화(GroupKFold) 검증과 제출까지 완주하는 학습형 CV 프로젝트입니다.",
    "description_en": "A learning CV project that classifies camera-trap images using HOG + scikit-learn probabilistic models, validated with site-grouped CV and completed through a full submission cycle.",
    "problem_ko": "촬영 site(환경) 변화가 커서 무작위 분할 평가가 실제 성능을 과대평가할 수 있고, 전통 특징 기반으로도 재현 가능한 end-to-end 제출 파이프라인이 필요함",
    "problem_en": "Large site/domain shifts can make random splits overestimate real performance; a reproducible end-to-end submission pipeline is needed even with traditional features.",
    "role_ko": "개인 프로젝트로 데이터/모델/검증 설계 및 실험 로깅·제출 파이프라인 구현",
    "role_en": "Solo: data/model/CV design, experiment logging, and end-to-end submission pipeline implementation.",
    "result_ko": "2026년 2월 14일 기준 GroupKFold(site) 평균 log loss 1.8639499 달성(리더보드 log loss 1.9354, 358/557)",
    "result_en": "As of Feb 14, 2026, Achieved CV mean log loss 1.8639499 (GroupKFold by site) | (leaderboard log loss 1.9354, rank 358/557).",
    "tags": ["Python", "scikit-learn", "scikit-image", "OpenCV"],
    "link": "https://www.notion.so/ml-c/WildlifeVision-Baseline-scikit-learn-30214b84a0f280ca907ed83b96bf138a?source=copy_link",
    "icon": "fas fa-paw",
    "last_used": "2026-02"
  },
